    ...
    if response.status_code == 200:
        ...
        if forecast_response.status_code == 200:
            ...
            if periods:
                ...
                temperature_f = current_weather['temperature']  # Temperature in Fahrenheit
                temperature_k = fahrenheit_to_kelvin(temperature_f)  # Convert to Kelvin
                ...
                return temperature_k, wind_speed, wind_direction, humidity, precipitation_chance
...
def display_7_day_forecast(forecast_data):
    ...
    for i in range(0, len(forecast_data), 2):  # Every 2 periods represent day and night
        ...
        temp_high_f = day_data['temperature']
        temp_high_k = fahrenheit_to_kelvin(temp_high_f)  # Convert high temperature to Kelvin
        temp_low_f = night_data['temperature']
        temp_low_k = fahrenheit_to_kelvin(temp_low_f)  # Convert low temperature to Kelvin
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #ddd; padding: 10px 0;">
            ...
            <div style="flex: 2; text-align: center;">{temp_high_k:.2f} K / {temp_low_k:.2f} K</div>
    ...
    if location_input:
        ...
        with col2:
            ...
            if 'lat' in locals() and 'lng' in locals():
                temperature_k, wind_speed, wind_direction,
